...
public:
   ...
   virtual void add_method_to_table(Symbol class_name) = 0;
   virtual void add_attr_to_table(Symbol) = 0;
...
public:
   ...
   void add_method_to_table(Symbol class_name);
   void add_attr_to_table(Symbol classname) {}
   void check_type();
