...
public:
    ...
    // TODO
    virtual Formal type_check(Environment env) = 0;
    virtual Symbol get_name() = 0;
...
public:
    ...
    // TODO
    virtual Expression type_check(Environment env) = 0;
...
public:
    ...
    // TODO
    virtual Symbol type_check(Environment env) = 0;
    virtual Symbol get_type() = 0;
...
public:
    ...
    void dump(ostream& stream, int n);
    // TODO
    Formal type_check(Environment env);
    Symbol get_name() { return name; };
...
public:
    ...
    void dump(ostream& stream, int n);
    // TODO
    Symbol type_check(Environment env);
    Symbol get_type() { return type_decl; };
...
public:
    ...
    void dump(ostream& stream, int n);
    // TODO
    Expression type_check(Environment env);
